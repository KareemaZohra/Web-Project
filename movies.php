...
<!--
Item isn’t working
User cookier maddhome nam dile user.php cholbe
Db te screenshot dte hbe eki idr 4ta kore
Photo isn’t being shown thikthak
Ajax
news
-->
  ...
  ?>
        ...
        <div class="row-2">
          <ul>
            ...
            <li class="m2"><a href="movies.php" class="active">Movies</a></li>
          ...
          <div class="wrapper">
            <div class="col-1">
              <div class="indent">
				...
				$query = 'select name,itemId,cover from item where category="movies"';
                ...
                font:7px Tahoma; text-decoration: none; background-color: #7806A4; 
